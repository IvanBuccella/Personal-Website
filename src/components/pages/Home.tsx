      ...
      <div className="page about-me">
        <div className="personal-information">
          ...
          <div className="right">
            ...
            <p className="name">Ivan Buccella</p>
            <p className="description">
              ...
              I'm a fan of "pair programming" and I love working in a team, we'll learn faster and much more.<br />
              Ah, yeah, I love the order...!<br /><br />
